import unittest
from project_euler import int_grid_creator, product_series, vertical_product_helper, adjacent_product_helper, largest_product_grid
import math
...
class TestProjectEuler(unittest.TestCase):
    ...
    def test_adjacent_product_helper(self):
        assert adjacent_product_helper(grid_input, 4, 0) == 5849100
